...
st.set_page_config(page_title="Story Grid Analyzer", page_icon="📖")

st.title("📖 The Story Grid Analyzer")
    ...
    if not scene_text:
        ...
        with st.spinner("Analyzing... (this may take 10-20 seconds)"):
            try:
                ...
                - Use Emoji bullets (🟢 for pass, 🔴 for fail).
                ...
                st.download_button(
                    label="📄 Download Beautiful Report (HTML)",
                    data=html_report,
